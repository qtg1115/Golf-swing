...
이 저장소는 **Brave Kid: School Story** 게임입니다. 전학생이 불리를 피하거나 맞서며 레벨과 아이템으로 학교생활을 하는 스토리 게임이고, 게임 안 문구는 모두 영어입니다.

스튜디오에서 `SchoolSimulator.rbxlx` 를 **File → Open from File** 로 연 뒤 **Play** 를 누르면 정문 앞 파란 발판에서 캐릭터가 나옵니다.
