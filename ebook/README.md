...
## Artwork: what is the author's, what is drawn here

Two different things live under `images/`, and they are never mixed.

**The author's own material — never replaced, never redrawn.** These stay exactly
as shot or exported, in their own palette, and no build step edits them:

| File | What it is |
|---|---|
| `photos/p2-c1-02-…jpg` | 스윙 어세스먼트 로드맵 diagram |
| `photos/p2-c1-03-…jpg` | 로드맵 1단계 diagram |
| `photos/p2-c1-04-…jpg` | 로드맵 2단계 diagram |
| `photos/p2-c1-05-…jpg` | 빠른 진단 맵 diagram |
| `photos/p4-c3-02-…jpg` | 하이 런치 course photo |

**Plates drawn by `scripts/make_plates.py`** — the cover art and the part
openers. They are drawn with shape maths and an ink-simulation pass, not
generated by an image model, so nothing figurative is invented and **no
...
| `plates/appendix-mark.jpg` | 부록 | small index mark, typography otherwise |
